...
final class CJPSPlus implements IRouting
{
    ...
    )
    {
        ...
        final DoubleMatrix1D l_return = new DenseDoubleMatrix1D( p_target.toArray() );
        l_return.assign( p_element.position(), Functions.minus );
        ...
        IntStream
            ...
            .range( 0, (int) l_return.getQuick( 0 ) )
